...
class ProjectAdapter (var dataList: ArrayList<Project>, private val myInterfaceForEdit: ProjectInterface, private val myInterfaceForDelete: ProjectInterface): RecyclerView.Adapter<SectionViewholder>() {
