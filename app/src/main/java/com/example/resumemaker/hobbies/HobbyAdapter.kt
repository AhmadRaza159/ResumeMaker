...
class HobbyAdapter (var dataList: ArrayList<Hobby>, private val myInterfaceForEdit: HobbyInterface, private val myInterfaceForDelete: HobbyInterface): RecyclerView.Adapter<SectionViewholder>() {
