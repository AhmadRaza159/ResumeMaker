...
class SkillAdapter(var dataList: ArrayList<Skill>, private val myInterfaceForEdit: SkillInterfaceAdapter, private val myInterfaceForDelete: SkillInterfaceAdapter): RecyclerView.Adapter<SectionViewholder>() {
    ...
    override fun onBindViewHolder(holder: SectionViewholder, position: Int) {
        holder.bindItems(dataList.get(position).title,dataList.get(position).expLevel)
